...
namespace RIAExample3.Web
{
    ...
    public sealed partial class AuthenticationContext : global::System.ServiceModel.DomainServices.Client.ApplicationServices.AuthenticationDomainContextBase
    {
        ...
        public AuthenticationContext() : 
                this(new WebDomainClient<IAuthenticationServiceContract>(new Uri("RIAExample3-Web-AuthenticationService.svc", UriKind.Relative)))
        {
        }
    ...
    /// </summary>
    [DataContract(Namespace="http://schemas.datacontract.org/2004/07/RIAExample3.Web")]
    public sealed partial class Employee : Entity
    {
        ...
        partial void OnAppendEmployeeInvoking();
        partial void OnAppendEmployeeInvoked();
        ...
        /// <summary>
        /// Gets a value indicating whether the 'AppendEmployee' action has been invoked on this entity.
        /// </summary>
        [Display(AutoGenerateField=false)]
        public bool IsAppendEmployeeInvoked
        {
            get
            {
                return base.IsActionInvoked("AppendEmployee");
            }
        }
        
        /// <summary>
        /// Gets a value indicating whether the 'AppendEmployee' method can be invoked on this entity.
        /// </summary>
        [Display(AutoGenerateField=false)]
        public bool CanAppendEmployee
        {
            get
            {
                return base.CanInvokeAction("AppendEmployee");
            }
        }
        ...
        /// <summary>
        /// Invokes the 'AppendEmployee' action on this entity.
        /// </summary>
        public void AppendEmployee()
        {
            this.OnAppendEmployeeInvoking();
            base.InvokeAction("AppendEmployee");
            this.OnAppendEmployeeInvoked();
        }
        
        protected override void OnActionStateChanged()
        {
            base.UpdateActionState("AppendEmployee", "CanAppendEmployee", "IsAppendEmployeeInvoked");
        }
    }
    
    /// <summary>
    /// The domain context corresponding to the 'EmployeeDomainService' domain service.
    /// </summary>
    public sealed partial class EmployeeDomainContext : DomainContext
    {
        ...
        public EmployeeDomainContext() : 
                this(new WebDomainClient<IEmployeeDomainServiceContract>(new Uri("RIAExample3-Web-EmployeeDomainService.svc", UriKind.Relative)))
        {
        }
        ...
        public EmployeeDomainContext(Uri serviceUri) : 
                this(new WebDomainClient<IEmployeeDomainServiceContract>(serviceUri))
        {
        }
        ...
        /// </summary>
        /// <param name="domainClient">The DomainClient instance to use for this domain context.</param>
        public EmployeeDomainContext(DomainClient domainClient) : 
                base(domainClient)
        {
            this.OnCreated();
        }
        ...
        /// <summary>
        /// Gets the set of <see cref="Employee"/> entities that have been loaded into this <see cref="EmployeeDomainContext"/> instance.
        /// </summary>
        ...
        /// <summary>
        /// Gets an EntityQuery instance that can be used to load <see cref="Employee"/> entities using the 'GetAllEmployees' query.
        /// </summary>
        /// <returns>An EntityQuery that can be loaded to retrieve <see cref="Employee"/> entities.</returns>
        public EntityQuery<Employee> GetAllEmployeesQuery()
        {
            this.ValidateMethod("GetAllEmployeesQuery", null);
            return base.CreateQuery<Employee>("GetAllEmployees", null, false, true);
        }
        ...
        protected override EntityContainer CreateEntityContainer()
        {
            return new EmployeeDomainContextEntityContainer();
        }
        
        /// <summary>
        /// Service contract for the 'EmployeeDomainService' domain service.
        /// </summary>
        [ServiceContract()]
        public interface IEmployeeDomainServiceContract
        {
            
            /// <summary>
            /// Asynchronously invokes the 'GetAllEmployees' operation.
            /// </summary>
            /// <param name="callback">Callback to invoke on completion.</param>
            /// <param name="asyncState">Optional state object.</param>
            /// <returns>An IAsyncResult that can be used to monitor the request.</returns>
            [FaultContract(typeof(DomainServiceFault), Action="http://tempuri.org/EmployeeDomainService/GetAllEmployeesDomainServiceFault", Name="DomainServiceFault", Namespace="DomainServices")]
            [OperationContract(AsyncPattern=true, Action="http://tempuri.org/EmployeeDomainService/GetAllEmployees", ReplyAction="http://tempuri.org/EmployeeDomainService/GetAllEmployeesResponse")]
            [WebGet()]
            IAsyncResult BeginGetAllEmployees(AsyncCallback callback, object asyncState);
            
            /// <summary>
            /// Completes the asynchronous operation begun by 'BeginGetAllEmployees'.
            /// </summary>
            /// <param name="result">The IAsyncResult returned from 'BeginGetAllEmployees'.</param>
            /// <returns>The 'QueryResult' returned from the 'GetAllEmployees' operation.</returns>
            QueryResult<Employee> EndGetAllEmployees(IAsyncResult result);
        ...
        internal sealed class EmployeeDomainContextEntityContainer : EntityContainer
        {
            
            public EmployeeDomainContextEntityContainer()
            {
                this.CreateEntitySet<Employee>((EntitySetOperations.Edit | EntitySetOperations.Remove));
            }
        }
    }
    ...
    public sealed partial class UserRegistrationContext : DomainContext
    {
        ...
        public UserRegistrationContext() : 
                this(new WebDomainClient<IUserRegistrationServiceContract>(new Uri("RIAExample3-Web-UserRegistrationService.svc", UriKind.Relative)))
        {
        }
