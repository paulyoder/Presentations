...
namespace RIAExample.Web
{
    ...
    public sealed partial class AuthenticationContext : global::System.ServiceModel.DomainServices.Client.ApplicationServices.AuthenticationDomainContextBase
    {
        ...
        public AuthenticationContext() : 
                this(new WebDomainClient<IAuthenticationServiceContract>(new Uri("RIAExample-Web-AuthenticationService.svc", UriKind.Relative)))
        {
        }
    ...
    /// </summary>
    [DataContract(Namespace="http://schemas.datacontract.org/2004/07/RIAExample.Web")]
    ...
    public sealed partial class EmployeeDomainContext : DomainContext
    {
        ...
        public EmployeeDomainContext() : 
                this(new WebDomainClient<IEmployeeDomainServiceContract>(new Uri("RIAExample-Web-EmployeeDomainService.svc", UriKind.Relative)))
        {
        }
        ...
        public interface IEmployeeDomainServiceContract
        {
            ...
            /// <param name="asyncState">Optional state object.</param>
            /// <returns>An IAsyncResult that can be used to monitor the request.</returns>
            [FaultContract(typeof(DomainServiceFault), Action="http://tempuri.org/EmployeeDomainService/GetEmployeesDomainServiceFault", Name="DomainServiceFault", Namespace="DomainServices")]
            [OperationContract(AsyncPattern=true, Action="http://tempuri.org/EmployeeDomainService/GetEmployees", ReplyAction="http://tempuri.org/EmployeeDomainService/GetEmployeesResponse")]
            [WebGet()]
    ...
    public sealed partial class UserRegistrationContext : DomainContext
    {
        ...
        public UserRegistrationContext() : 
                this(new WebDomainClient<IUserRegistrationServiceContract>(new Uri("RIAExample-Web-UserRegistrationService.svc", UriKind.Relative)))
        {
        }
